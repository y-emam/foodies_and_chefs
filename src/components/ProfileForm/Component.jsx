      ...
      <div className="flex flex-col justify-center h-1/2 w-full space-y-5">
        ...
        <div className="relative flex flex-col justify-center items-center">
          ...
          <button
            ...
            onClick={() =>
              isEditable ? handleProfileImgChange() : navigate("/profile/edit")
            }
          >
          ...
          {/* Error Message */}
          {profilePicError && (
            <div className="text-red-500 font-bold mt-2">{profilePicError}</div>
          )}
        </div>
      </div>
          ...
          <div className="self-start  w-full border-t-2 border-main-color md:text-[22px]  text-[15px]">
            ...
            <div className="flex justify-center items-center my-5 relative">
              ...
              <input
                ...
                id="InsragramAccount"
                value={userData?.insragramAccount}
                onChange={(e) =>
                  setUserData({ ...userData, insragramAccount: e.target.value })
                }
              />
            </div>
            <div className="flex justify-center items-center my-5 relative">
              ...
              <input
                ...
                onChange={(e) =>
                  setUserData({ ...userData, facebookAccount: e.target.value })
                }
              />
            </div>
            <div className="flex justify-center items-center my-5 relative">
              ...
              <input
                ...
                name="XAccount"
                id="XAccount"
                value={userData?.xAccount}
                onChange={(e) =>
                  setUserData({ ...userData, xAccount: e.target.value })
                }
              />
            </div>
            {/* Error Message */}
