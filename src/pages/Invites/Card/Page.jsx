...
import InvCardBgImg from "../../../assets/images/invCardBG1.png";
    ...
    <>
      ...
      >
        <div className="w-full h-full npm bg-cover bg-no-repeat flex flex-col">
          ...
          <p className="mb-5 md:mb-10 plus-jakarta-sans text-center text-[#FA8836] md:text-[22px] text-sm italic font-normal">
          ...
          <div className="flex flex-col justify-center items-center w-full relative">
            ...
            >
              ...
              {/* Three spoons */}
              <img
                className="w-[48rem] h-auto absolute left-0 -z-10"
                src={Spoon1Img}
                alt=""
              />

              <div className="w-full flex flex-col items-center justify-center">
                <div className="max-h-fit flex flex-col npm  bg-no-repeat bg-auto w-full md:w-10/12 items-center">
                  {/* Chef name */}
