      ...
      <section className="min-h-screen  md:space-y-20 space-y-10 md:min-h-full flex flex-col w-full items-center justify-center    p-3  md:p-5 z-10 text-start lato-bold md:pl-10 plus-jakarta-sans ">
        ...
        >
            ...
            <span className="mx-2">
              ...
              >
                <mask
                  ...
                  height="22"
                >
                  <rect width="22" height="22" fill="url(#pattern0_6164_23)" />
                </mask>
                <g mask="url(#mask0_6164_23)">
                  <rect x="-13" width="51" height="40" fill="#8BE6FF" />
                </g>
                <defs>
                  <pattern
                    id="pattern0_6164_23"
            ...
            <span className="mx-2">
              ...
              >
                <mask
                  ...
                  height="20"
                >
                  <rect width="20" height="20" fill="url(#pattern0_6164_20)" />
                </mask>
                <g mask="url(#mask0_6164_20)">
                  <rect x="-5" width="31" height="26" fill="white" />
                </g>
                <defs>
                  <pattern
                    id="pattern0_6164_20"
            ...
            <span className="mx-2">
              ...
              >
                <mask
                  ...
                  height="20"
                >
                  <rect width="20" height="20" fill="url(#pattern0_6164_17)" />
                </mask>
                <g mask="url(#mask0_6164_17)">
                  <rect
                    x="-4.86523"
                    y="-4.05408"
                    width="28.3784"
              ...
              <span className="mx-2">
                ...
                >
                  <rect
                    width="28"
                    height="28"
                    fill="url(#pattern0_6107_4739)"
                  />
                  <defs>
                    <pattern
                      id="pattern0_6107_4739"
                      patternContentUnits="objectBoundingBox"
                      width="1"
                      height="1"
                    >
              ...
              <span className="mx-2">
                ...
                >
                  <rect
                    width="28"
                    height="28"
                    fill="url(#pattern0_6107_4742)"
                  />
                  <defs>
                    <pattern
                      id="pattern0_6107_4742"
                      patternContentUnits="objectBoundingBox"
                      width="1"
                      height="1"
                    >
          ...
          <input
            type="hidden"
            name="EventID"
            value="55762767-8513-4467-e4e4-08dd3f7c0419"
            data-val="true"
